function [CVstats, CVstats_mu, CVstats_std, h0, t0] = KfoldCrossValCCA(X,Y,Ymu,Ysigma,dp,dt,dcca,k,verbal,weights)
...
for i = 1:size(indexVal,2)
    ...
    [~,B] = ccr(XCal',YCal',dp,dt,dcca); % Apply PLS on calibration block; 
...
% Written by M.Osman, May 2019 (osmanm@mit.edu)
% Inputs:
...
% Modified by M. Osman, May 2019 (osmanm@mit.edu)
% INPUTS
